...
SENSOR_TYPES = {
    ...
    'yesterday_usage': ['Yesterday usage', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'yesterday_consumption': ['Yesterday consumption', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'yesterday_consumption_peak': ['Yesterday consumption peak', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'yesterday_consumption_offpeak': ['Yesterday consumption offpeak', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'yesterday_consumption_shoulder': ['Yesterday consumption shoulder', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'yesterday_consumption_controlled_load': ['Yesterday consumption controlled load', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'yesterday_generation': ['Yesterday generation', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    ...
    'yesterday_percentage_difference': ['Yesterday percentage difference', KILOWATT_HOUR, 'mdi:percent', 'energy', SensorStateClass.TOTAL],
    'yesterday_difference_message': ['Yesterday difference message', 'text', 'mdi:clipboard-text'],
    'yesterday_consumption_difference': ['Yesterday consumption difference', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'yesterday_consumption_change': ['Yesterday consumption change', KILOWATT_HOUR, 'mdi:swap-vertical', 'energy', SensorStateClass.TOTAL],
    'yesterday_suburb_average': ['Yesterday suburb average', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'previous_day_usage': ['Previous day usage', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'previous_day_consumption': ['Previous day consumption', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'previous_day_generation': ['Previous day generation', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    ...
    'this_week_usage': ['This week usage', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_week_consumption': ['This week consumption', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_week_consumption_peak': ['This week consumption peak', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_week_consumption_offpeak': ['This week consumption offpeak', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_week_consumption_shoulder': ['This week consumption shoulder', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_week_consumption_controlled_load': ['This week consumption controlled load', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_week_generation': ['This week generation', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    ...
    'this_week_percentage_difference': ['This week percentage difference', KILOWATT_HOUR, 'mdi:percent', 'energy'],
    'this_week_difference_message': ['This week difference message', 'text', 'mdi:clipboard-text'],
    'this_week_consumption_difference': ['This week consumption difference', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_week_consumption_change': ['This week consumption change', KILOWATT_HOUR, 'mdi:swap-vertical', 'energy'],
    'this_week_suburb_average': ['This week suburb average', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'last_week_usage': ['Last week usage', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'last_week_consumption': ['Last week consumption', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'last_week_generation': ['Last week generation', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_month_user_type': ['This month user type', 'type', 'mdi:home-account'],
    'this_month_usage': ['This month usage', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_month_consumption': ['This month consumption', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_month_consumption_peak': ['This month consumption peak', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_month_consumption_offpeak': ['This month consumption offpeak', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_month_consumption_shoulder': ['This month consumption shoulder', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_month_consumption_controlled_load': ['This month consumption controlled load', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_month_generation': ['This month generation', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    ...
    'this_month_consumption_difference': ['This month consumption difference', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'this_month_consumption_change': ['This month consumption change', KILOWATT_HOUR, 'mdi:swap-vertical'],
    'this_month_suburb_average': ['This month suburb average', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],

    'last_month_usage': ['Last month usage', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'last_month_consumption': ['Last month consumption', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
    'last_month_generation': ['Last month generation', KILOWATT_HOUR, 'mdi:flash', 'energy', SensorStateClass.TOTAL],
}
...
class JemenaOutlookSensor(Entity):
    ...
    def __init__(self, jemenaoutlook_data, sensor_type, name):
        ...
        self._state = None
        self._device_class = SENSOR_TYPES[sensor_type][3] if len(SENSOR_TYPES[sensor_type]) > 3 else None
        self._state_class = SENSOR_TYPES[sensor_type][4] if len(SENSOR_TYPES[sensor_type]) > 4 else None
